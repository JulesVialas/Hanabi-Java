...
public class TestJetonsPlateau {
     ...
     * {@link jeu.modele.JetonsPlateau#JetonsPlateau()}.
     */
    @BeforeEach
    public void setUp() {
    ...
    /**
     * Méthode de test pour
     * {@link jeu.modele.JetonsPlateau#setRouge(int)}.
     */
    @Test
    ...
    /**
     * Méthode de test pour
     * {@link jeu.modele.JetonsPlateau#incrementBleus()}.
     */
    @Test
    ...
    /**
     * Méthode de test pour
     * {@link jeu.modele.JetonsPlateau#decrementBleus()}.
     */
    @Test
    ...
    /**
     * Méthode de test pour
     * {@link jeu.modele.JetonsPlateau#incrementRouges()}.
     */
    @Test
    ...
    /**
     * Méthode de test pour
     * {@link jeu.modele.JetonsPlateau#decrementRouges()}.
     */
    @Test
    ...
    void testGetBleus() {
        // testé dans{@link
        // modele.jeu.TestJetonsPlateau#testValeursInitiales()}
        // {@link modele.jeu.TestJetonsPlateau#testSetBleuValide()}
        // {@link
        // modele.jeu.TestJetonsPlateau#testIncrementeJetonsBleusValide()}
    ...
    void testGetRouges() {
        ...
        // {@link
        // modele.jeu.TestJetonsPlateau#testIncrementeJetonsRougesValide()}
    }
}
