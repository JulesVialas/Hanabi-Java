 ...
 * un pseudo et une main de cartes.
 * 
 * @author Jules Vialas
...
public class Joueur {
     ...
     * comporter entre 2 et 10 caractères. Il ne peut pas être composés uniquement
     * d'espaces, ni être null.
     * 
     * @param pseudo le pseudo du joueur
     * @throws IllegalArgumentException si les règles de validité de construction
     *                                  d'un pseudo ne sont pas respectées.
     */
