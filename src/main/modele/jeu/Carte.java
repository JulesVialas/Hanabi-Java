...
public class Carte {
    ...
    /**
     * Créé les cartes du jeu de base d'Hanabi.
     * Chacune des cinq couleurs comporte la suit la répartition 
     * suivante: 1,1,1,2,2,3,3,4,4,5
    ...
    public static Carte[] jeuComplet() {
        ...
        /* 
         * On stocke les cartes dans le tableau paquet pour eviter
         * un return encore moins lisible que ça :')
         */
        paquet[0] = unRouge1;
        paquet[1] = unRouge2;
        paquet[2] = unRouge3;
