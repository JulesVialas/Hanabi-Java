...
import jeu.application.controleur.PartieFinie;
...
/**
 * Point d'entrée de l'application Hanabi. Ouvre l'application sur le
 * menu principal.
 *
...
public class Hanabi extends Application {
    ...
    /**
     * Scène permettant de gérer la confirmation de la sauvegarde de la
     * partie
     */
    private static Scene sceneConfirmationSauvegarde;

    /**
     * Scène permettant de gérer la fin de partie
     */
    private static Scene scenePartieFinie;

    /**
     * Fenêtre principale de l'application La scène qui lui est associée
     * sera modifiée en fonction des clics de l'utilisateur
     */
    public static Stage fenetrePrincipale;

    /**
     * Permet de modifier la scène de la fenêtre principale pour qu'elle
     * devienne la scène principale, celle qui affiche les 2 boutons
     * ChoixJoueurs et Parametres
     */
    ...
    /**
     * Permet de modifier la scène de la fenêtre principale pour qu'elle
     * devienne celle de ChoixJoueurs
     */
    ...
    /**
     * Change la scène de la fenêtre principale pour qu'elle devienne
    ...
    public static void activerTableDeuxJoueurs(Partie partie) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/TableDeuxJoueurs.fxml"));
    ...
    /**
     * Permet de modifier la scène de la fenêtre principale pour qu'elle
     * devienne celle de TableTroisJoueurs
     *
     * @param partie la partie qui se déroule
     */
    public static void activerTableTroisJoueurs(Partie partie) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/TableTroisJoueurs.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scène de la fenêtre principale pour qu'elle
     * devienne celle de TableQuatreJoueurs
     *
     * @param partie la partie qui se déroule
     */
    public static void activerTableQuatreJoueurs(Partie partie) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/TableQuatreJoueurs.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scène de la fenêtre principale pour qu'elle
     * devienne celle de TableCinqJoueurs
     *
     * @param partie la partie qui se déroule
     */
    public static void activerTableCinqJoueurs(Partie partie) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/TableCinqJoueurs.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scène de la fenetre principale pour qu'elle
     * devienne celle de ChangerTheme
     */
    @FXML
    public static void activerChangerTheme() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/ChangerTheme.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scène de la fenetre principale pour qu'elle
     * devienne celle de PersonnaliserPartie
     */
    @FXML
    public static void activerPersonnaliserPartie() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/PersonnaliserPartie.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scène de la fenetre principale pour qu'elle
     * devienne celle de ChoixSauvegardePartie
     */
    @FXML
    public static void activerChoixSauvegardePartie() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/ChoixSauvegardePartie.fxml"));
            Parent root = loader.load();
    ...
    public static void activerRegles() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/Regles.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scene de la fenêtre principale pour qu'elle
     * devienne celle de Sauvegarder
     */
    @FXML
    public static void activerSauvegarder() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    Hanabi.class.getResource("vue/Sauvegarde.fxml"));
            Parent root = loader.load();
    ...
    /**
     * Permet de modifier la scene de la fenêtre principale pour qu'elle
     * devienne celle de ConfirmationSauvegarder
     */
    @FXML
    public static void activerConfirmationSauvegarde() {
        try {
            FXMLLoader loader = new FXMLLoader(Hanabi.class
                    .getResource("vue/ConfirmationSauvegarde.fxml"));
            Parent root = loader.load();
    ...
    public static void activerPartieFinie(Partie partie) {
        try {
            ...
            scenePartieFinie = new Scene(root, 800, 600);
            fenetrePrincipale.setScene(scenePartieFinie);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start(Stage primaryStage) {
        try {
            /*
             * chargement de la vue de la scène principale dans le conteneur de
             * type Parent
             */
            ...
            /*
             * Chargement de la vue ChoixJoueurs et création de la scène
             * associée à cette vue
             */
            FXMLLoader chargeurFXMLChoixJoueurs = new FXMLLoader();
            chargeurFXMLChoixJoueurs.setLocation(
                    getClass().getResource("vue/ChoixJoueurs.fxml"));
            conteneur = chargeurFXMLChoixJoueurs.load();
            sceneChoixJoueurs = new Scene(conteneur, 800, 600);

            /*
             * Chargement de la vue Parametres et création de la scène associée
             * à cette vue
             */
            FXMLLoader chargeurFXMLParametres = new FXMLLoader();
            chargeurFXMLParametres
                    .setLocation(getClass().getResource("vue/Parametres.fxml"));
            conteneur = chargeurFXMLParametres.load();
            sceneParametres = new Scene(conteneur, 800, 600);

            /*
             * Chargement de la vue TableDeuxJoueurs et création de la scène
             * associée à cette vue
             */
            FXMLLoader chargeurFXMLTableDeuxJoueurs = new FXMLLoader();
            chargeurFXMLTableDeuxJoueurs.setLocation(
                    getClass().getResource("vue/TableDeuxJoueurs.fxml"));
            conteneur = chargeurFXMLTableDeuxJoueurs.load();
            sceneTableDeuxJoueurs = new Scene(conteneur, 800, 600);

            /*
             * Chargement de la vue TableTroisJoueurs et création de la scène
             * associée à cette vue
             */
            FXMLLoader chargeurFXMLTableTroisJoueurs = new FXMLLoader();
            chargeurFXMLTableTroisJoueurs.setLocation(
                    getClass().getResource("vue/TableTroisJoueurs.fxml"));
            ...
            chargeurFXMLTableQuatreJoueurs.setLocation(
                    getClass().getResource("vue/TableQuatreJoueurs.fxml"));
            conteneur = chargeurFXMLTableQuatreJoueurs.load();
            sceneTableQuatreJoueurs = new Scene(conteneur, 800, 600);

            /*
             * Chargement de la vue TableCinqJoueurs et création de la scène
             * associée à cette vue
             */
            FXMLLoader chargeurFXMLTableCinqJoueurs = new FXMLLoader();
            chargeurFXMLTableCinqJoueurs.setLocation(
                    getClass().getResource("vue/TableCinqJoueurs.fxml"));
            ...
            chargeurFXMLChangerTheme.setLocation(
                    getClass().getResource("vue/ChangerTheme.fxml"));
            ...
            chargeurFXMLPersonnaliserPartie.setLocation(
                    getClass().getResource("vue/PersonnaliserPartie.fxml"));
            conteneur = chargeurFXMLPersonnaliserPartie.load();
            sceneTheme = new Scene(conteneur, 800, 600);

            FXMLLoader chargeurFXMLChoixSauvegardePartie = new FXMLLoader();
            chargeurFXMLChoixSauvegardePartie.setLocation(
                    getClass().getResource("vue/ChangerTheme.fxml"));
            ...
            chargeurFXMLRegles
                    .setLocation(getClass().getResource("vue/Regles.fxml"));
            conteneur = chargeurFXMLRegles.load();
            sceneRegles = new Scene(conteneur, 800, 600);

            FXMLLoader chargeurFXMLSauvegarde = new FXMLLoader();
            chargeurFXMLSauvegarde
                    .setLocation(getClass().getResource("vue/Sauvegarde.fxml"));
            conteneur = chargeurFXMLSauvegarde.load();
            sceneSauvegarde = new Scene(conteneur, 800, 600);

            FXMLLoader chargeurFXMLConfirmationSauvegarde = new FXMLLoader();
            chargeurFXMLConfirmationSauvegarde.setLocation(
                    getClass().getResource("vue/ConfirmationSauvegarde.fxml"));
            conteneur = chargeurFXMLConfirmationSauvegarde.load();
            sceneConfirmationSauvegarde = new Scene(conteneur, 800, 600);

            FXMLLoader chargeurFXMLPartieFinie = new FXMLLoader();
            chargeurFXMLPartieFinie.setLocation(
                    getClass().getResource("vue/PartieFinie.fxml"));
            conteneur = chargeurFXMLPartieFinie.load();
            scenePartieFinie = new Scene(conteneur, 800, 600);
            ...
            /*
             * on associe la scène principale à la fenêtre principale Cette
             * dernière est stockée en tant qu'attribut afin d'être accessible
             * dans les méthodes activer... Celles qui permettent de rendre
             * active l'une des 3 scènes
             */
