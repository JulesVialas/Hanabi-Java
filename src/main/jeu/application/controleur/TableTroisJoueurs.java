...
public class TableTroisJoueurs {
	...
	public void setPartie(Partie partie) {
		if (partie != null) {
			...
			joueur3Carte5.setStyle("-fx-background-color: #"
					+ convertirCouleurEnHex(partie.getJoueur3().getCartesEnMains().get(4).getCouleur()) + ";");
			...
			joueur3Carte5.setText(
					Integer.toString(partie.getJoueur3().getCartesEnMains().get(4).getValeur().getValeurNumerique()));
		}
	}
