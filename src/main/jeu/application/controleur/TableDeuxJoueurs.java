...
public class TableDeuxJoueurs {
    ...
    private static final String ERREUR_PARTIE_NULL = "Erreur: une partie ne peut pas être null";
    ...
    public void setPartie(Partie partie) {
        ...
        if (partie != null) {
            ...
            joueur2Carte5
                    .setStyle("-fx-background-color: #"
                            + convertirCouleurEnHex(partie.getJoueur2()
                                    .getCartesEnMains().get(4).getCouleur())
                            + ";");
            ...
            joueur2Carte5.setText(
                    Integer.toString(partie.getJoueur2().getCartesEnMains()
                            .get(4).getValeur().getValeurNumerique()));
        } else {
