...
/**
 * La classe Pioche représente la pioche de carte dans jeu Hanabi. La
 * pioche est une pile de cartes. Les cartes présentes dans la pioche
 * sont inutilisées et ne le sont qu'une fois que le joueur à piocher
 * la carte.
 */
public class Pioche {
