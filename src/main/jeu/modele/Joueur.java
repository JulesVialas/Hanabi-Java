...
/**
 * La classe Joueur représente un joueur dans un jeu de cartes. Chaque
 * joueur a un pseudo et une main de cartes.
 *
 * @author Jules Vialas
...
public class Joueur {
    ...
    private static final String ERREUR_PSEUDO_INVALIDE = "Erreur: Le pseudo doit comporter entre 2 et 10 caractères et ne doit "
    ...
    /**
     * Instancie un objet de type Joueur à l'aide de son pseudo. Le pseudo
     * peut comporter entre 2 et 10 caractères. Il ne peut pas être
     * composés uniquement d'espaces, ni être null.
     *
     * @param pseudo le pseudo du joueur
     * @throws IllegalArgumentException si les règles de validité de
     *                                  construction d'un pseudo ne sont
     *                                  pas respectées.
     */
