...
/**
 * La classe JetonsPlateau représente les jetons du jeu Hanabi. Il
 * existe deux types de jetons :
 * <ul>
 * <li>Les jetons bleus, 8 en début de partie. L'équipe perd un jeton
 * bleu lorsqu'il donne une information.L'équipe gagne un jeton bleu
 * lorsqu'il défausse une carte de sa main.</li>
 * <li>Les jetons rouges, 0 en début de partie. L'équipe reçoit un
 * jeton rouge lorsqu'une carte est jouée et qu'elle ne vient
 * compléter aucun feu d’artifice</li>
 * </ul>
 *
 * @author Jules Vialas
 */
...
public class JetonsPlateau {
    ...
    /**
     * jeton bleu est instancié avec la valeur par défaut
     * NB_JETONS_BLEUS_MAX jeton rouge est instancié avec la valeur par
     * défaut NB_JETONS_ROUGES_MIN
     *
     * @param bleu
     * @param rouge
     */
     ...
     *
     * @param nombre
     * @throws IllegalStateException si le nombre de jetons bleus inscrit
     *                               en paramètre n'est pas valide.
     */
     ...
     *
     * @param nombre
     * @throws IllegalStateException si le nombre de jetons rouges inscrit
     *                               en paramètre n'est pas valide.
     */
     ...
     *
     * @throws IllegalStateException si le nombre de jetons bleus n'est
     *                               pas valide lors d'une incrémentation.
     */
     ...
     *
     * @throws IllegalStateException si le nombre de jetons bleus n'est
     *                               pas valide lors d'une décrémentation.
     */
     ...
     *
     * @throws IllegalStateException si le nombre de jetons rouges n'est
     *                               pas valide lors d'une incrémentation.
     */
