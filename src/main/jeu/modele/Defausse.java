...
/**
 * La classe Defausse représente la défausse de cartes dans le jeu Hanabi. Il
 * s'agit d'une pile de cartes. Les cartes présentes dans la défausse sont
 * consultables par les joueurs pour orienter leurs décisions.
 *
...
public class Defausse {
	...
	/**
	 * Instancie un objet de type Defausse. La defausse est vide par défaut.
	 */
	public Defausse() {
		this.pile = new Stack<>();
	}
	 ...
	 *
	 * @param pileAInserer Nouvelle pile de cartes qui constitue la défausse.
	 */
