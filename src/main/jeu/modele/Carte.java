...
/**
 * La classe Carte représente une carte du jeu Hanabi. Chaque carte
 * possède une couleur et une valeur. Le jeu Hanabi comporte :
 * <ul>
 * <li>50 cartes</li>
 ...
 * </ul>
 * <br>
 * Pour chacune des 5 couleurs des cartes, la distribution des valeurs
 * est 1, 1, 1, 2, 2, 3, 3, 4, 4, 5.
 */
public class Carte {
    ...
    /**
     * @return couleurConnue Le status de la visibilité de la couleur de
     *         la carte
     */
    ...
    /**
     * @return valeurConnue Le status de la visibilité de la valeur de la
     *         carte
     */
    ...
    /**
     * Créé les cartes du jeu de base d'Hanabi. Chacune des cinq couleurs
     * comporte la suit la répartition suivante: 1,1,1,2,2,3,3,4,4,5
     *
    ...
    public static Carte[] jeuComplet() {
        ...
        /*
         * On stocke les cartes dans le tableau paquet pour eviter un return
         * encore moins lisible que ça :')
         */
        paquet[0] = unRouge1;
        paquet[1] = unRouge2;
        paquet[2] = unRouge3;
    ...
    public String toString() {
        return "[" + getCouleur() + " " + getValeur() + " couleur visible "
                + getCouleurConnue() + " valeur visible " + getValeurConnue()
                + "]";
    }
}
